...
CITE, DE FORMA OBJETIVA, CASOS E SITUAÇÕES REAIS" TEXT,
    ...
    CONSTRAINT "auto_avaliacoes_importadas_importHistoryId_fkey" FOREIGN KEY ("importHistoryId") REFERENCES "import_history" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_auto_avaliacoes_importadas" ("AUTO-AVALIAÇÃO", "CRITÉRIO", "Ciclo (ano.semestre)", "DADOS E FATOS DA AUTO-AVALIAÇÃO
CITE, DE FORMA OBJETIVA, CASOS E SITUAÇÕES REAIS", "DESCRIÇÃO GERAL", "DESCRIÇÃO NOTA", "Email do Colaborador", "dataImportacao", "id", "importHistoryId") SELECT "AUTO-AVALIAÇÃO", "CRITÉRIO", "Ciclo (ano.semestre)", "DADOS E FATOS DA AUTO-AVALIAÇÃO
CITE, DE FORMA OBJETIVA, CASOS E SITUAÇÕES REAIS", "DESCRIÇÃO GERAL", "DESCRIÇÃO NOTA", "Email do Colaborador", "dataImportacao", "id", "importHistoryId" FROM "auto_avaliacoes_importadas";
...
CREATE TABLE "new_avaliacoes_360_importadas" (
    ...
    "dataImportacao" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "importHistoryId" TEXT,
    CONSTRAINT "avaliacoes_360_importadas_importHistoryId_fkey" FOREIGN KEY ("importHistoryId") REFERENCES "import_history" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_avaliacoes_360_importadas" ("Ciclo (ano.semestre)", "DÊ UMA NOTA GERAL PARA O COLABORADOR", "EMAIL DO AVALIADO ( nome.sobrenome )", "Email do Colaborador", "PERÍODO", "PONTOS QUE DEVE MELHORAR", "PONTOS QUE FAZ BEM E DEVE EXPLORAR", "PROJETO EM QUE ATUARAM JUNTOS - OBRIGATÓRIO TEREM ATUADOS JUNTOS", "VOCÊ FICARIA MOTIVADO EM TRABALHAR NOVAMENTE COM ESTE COLABORADOR", "dataImportacao", "id", "importHistoryId") SELECT "Ciclo (ano.semestre)", "DÊ UMA NOTA GERAL PARA O COLABORADOR", "EMAIL DO AVALIADO ( nome.sobrenome )", "Email do Colaborador", "PERÍODO", "PONTOS QUE DEVE MELHORAR", "PONTOS QUE FAZ BEM E DEVE EXPLORAR", "PROJETO EM QUE ATUARAM JUNTOS - OBRIGATÓRIO TEREM ATUADOS JUNTOS", "VOCÊ FICARIA MOTIVADO EM TRABALHAR NOVAMENTE COM ESTE COLABORADOR", "dataImportacao", "id", "importHistoryId" FROM "avaliacoes_360_importadas";
...
CREATE TABLE "new_perfis_importados" (
    ...
    "importHistoryId" TEXT,
    CONSTRAINT "perfis_importados_importHistoryId_fkey" FOREIGN KEY ("importHistoryId") REFERENCES "import_history" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_perfis_importados" ("Ciclo (ano.semestre)", "Nome ( nome.sobrenome )", "Unidade", "email", "id", "importHistoryId") SELECT "Ciclo (ano.semestre)", "Nome ( nome.sobrenome )", "Unidade", "email", "id", "importHistoryId" FROM "perfis_importados";
...
( nome.sobrenome )" TEXT NOT NULL,
    ...
    "dataImportacao" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "importHistoryId" TEXT,
    CONSTRAINT "pesquisas_referencia_importadas_importHistoryId_fkey" FOREIGN KEY ("importHistoryId") REFERENCES "import_history" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_pesquisas_referencia_importadas" ("Ciclo (ano.semestre)", "EMAIL DA REFERÊNCIA
( nome.sobrenome )", "Email do Colaborador", "JUSTIFICATIVA", "dataImportacao", "id", "importHistoryId") SELECT "Ciclo (ano.semestre)", "EMAIL DA REFERÊNCIA
( nome.sobrenome )", "Email do Colaborador", "JUSTIFICATIVA", "dataImportacao", "id", "importHistoryId" FROM "pesquisas_referencia_importadas";
