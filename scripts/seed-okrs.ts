...
async function main() {
    ...
    data: [
      {
        ...
        title: 'Alcançar 50.000 usuários ativos mensais',
        description: 'Meta de crescimento de usuários ativos na plataforma',
        type: 'NUMBER',
        targetValue: 50000,
        currentValue: 32500,
        unit: 'usuários',
      ...
      {
        objectiveId: obj1_1.id,
        title: 'Aumentar retenção de usuários para 75%',
    ...
    data: [
      {
        ...
        title: 'Reduzir tempo de carregamento para menos de 2s',
    ...
    data: [
      {
        ...
        title: 'Implementar 5 microserviços críticos',
        description: 'Auth, Users, Orders, Products, Notifications',
        type: 'NUMBER',
        targetValue: 5,
        currentValue: 5,
        unit: 'serviços',
      ...
      {
        objectiveId: obj2_1.id,
        title: 'Migrar 100% das funcionalidades',
    ...
    data: [
      {
        ...
        title: 'Pipeline de CI/CD funcionando',
      ...
      {
        objectiveId: obj2_2.id,
        title: 'Cobertura de testes acima de 90%',
        description: 'Testes automatizados cobrindo 90% do código',
        type: 'PERCENTAGE',
        targetValue: 90,
        currentValue: 94,
        unit: '%',
  ...
  await prisma.keyResult.createMany({
    data: [
      ...
      {
        objectiveId: obj3_1.id,
        title: 'App Android na Play Store',
      ...
      {
        objectiveId: obj3_1.id,
        title: 'Implementar 70% das funcionalidades core',
        description: 'Funcionalidades essenciais nos apps',
        type: 'PERCENTAGE',
        targetValue: 70,
        currentValue: 35,
        unit: '%',
  ...
  await prisma.keyResult.createMany({
    data: [
      ...
      {
        objectiveId: obj5_1.id,
        title: 'Reduzir tempo de resposta para 2h',
